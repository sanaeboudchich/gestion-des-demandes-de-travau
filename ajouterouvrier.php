   ...
   <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="espaceadministratif.php">retour</a>
        </li>
...
<br/>
<center>
 <h3 align="center" style="color:#56828B;">Veuillez saisir les informations pour ajouter un nouvel ouvrier</h3>
 <br/>
...
<form action="" method="POST">
                        ...
                        <select  placeholder= "role.." name="metier"required>                        
                        ...
                        <input name="id_utilsateur" type="text" placeholder="id_utilisateu.." required/> 
                        <br/> 
                        <input  type="submit" value="Ajouter ouvrier" name="ajt"required/>
                        <br/>
</form>
</center>
                  <br/>
...
if(isset($_POST['ajt']))
{
      ...
      $metier = $_POST['metier'];
      $id_utilsateur = $_POST['id_utilsateur'];


      

      $requete="INSERT INTO ouvrier (id_utilisateur, nom, email, tele, codep, prestation, ville, prenom, adresse, pays) 
                                 VALUES ('$id_utilsateur', '$nom', '$email', '$tel', '$cp', '$metier', '$ville', '$prenom', '$adresse', '$pays')"; 
      $resultat = mysqli_query($con,$requete);

            if($resultat)
            {
              header('Location: ajouterouvrier.php');
            }
            else{
            echo"erreur";
            printf("Error: %s\n", mysqli_error($con));
