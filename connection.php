...
<body>
 ...
 <br/>
                       ...
                       <h3 align="center" style="color:#56828B;">---------Veuillez vous connectez à votre espace !---------</h3>
 <br/>
 <br/>
...
<center> <form action="login.php" method="POST">
                       ...
                       <input name="user" type="text" placeholder="Identifiant.." required/> <br/>
 
                       <input name="mdp" type="password" placeholder="Mot de passe .." required/> 
                        <br />
                        <input  type="submit" value="Connexion" name="cnx" />
