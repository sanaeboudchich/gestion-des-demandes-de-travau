...
<br/>
<center>
 <h3 align="center" style="color:#56828B;">Veuillez saisir les informations du compte</h3>
 <br/>
...
<form action="test.php" method="POST">
                       ...
                       <center></center>
                        ...
                        <option value="espace technique">espace technique</option>
                        <option value="espace comptable">espace comptable</option>
                        ...
                        <br />
                        <input  type="submit" value="Ajouter un compte ouvrier" name="ajt" />
                        <br/>
                        </center>
</form>
</center>
