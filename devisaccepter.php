...
<center><form action="" method="post">
                      ...
                      <input name="id_devis" type="text" placeholder="id_devis .." required /> 
                       <input name="id_ouvrier" type="text" placeholder="Id_ouvrier.." required /> <br/>
 
                       <input name="id_prestation" type="text" placeholder="id_prestation .." required /> 
                        <br />
...
$id_devis=$_POST['id_devis'];
 $id_ouvrier=$_POST['id_ouvrier'];
 $id_prestation=$_POST['id_prestation'];
 $prestation=mysqli_query($con,"INSERT INTO `prestation`(`id_utilisateur`, `id_devis`, `id_prestation`) VALUES ('$id_ouvrier','$id_devis',
  '$id_prestation')");
 if ($prestation) {
   echo"<script> alert('Prestation bien ajouter'); </script>";
 } else {
