...
<br/>
 ...
 <center>
 <h3 align="center" style="color:#56828B;">Veuillez saisir vos informations pour compléter votre demande de devis</h3>
 <br/>
...
<form action="" method="post">
                        ...
                        <input name="id_devis" type="text" placeholder="id_devis.." required/>  <input name="name" type="text" placeholder="Nom et Prénom.." required/>
                        <br/> 
                                               
                        <input  name="email" type="text" placeholder="email.."required/>  <input name="tele" type="text"placeholder="Téléphone.." required/>
                                                                                <br/> 
                        ...
                        <input name="codep" type="text" placeholder="Code Postale.."required/>      <input name="adress" type="text" placeholder="Adresse.."required />
                        <br/>
                        ...
                        <select  placeholder= "Type de préstation.." name="prestation">                        
                        ...
                        <input name="dateS" type="text" placeholder="Date Souhaitée (JJ/MM/AA).." /> 
                        <br/> 
                        <input  type="submit" name="EnvDevis" value="Envoyer la demande de devis" />
                        <br/>
</form>

<?php

if (isset($_POST['EnvDevis'])) {
 ...
 $devis=mysqli_query($con, "INSERT INTO `devis`(`id_devis`, `nometp`, `email`, `tele`, `pays`, `ville`, `codep`, `adress`, `prestation`, `dateS`) VALUES ('$id_devis','$nametp','$email','$tele','$pays','$ville','$codep','$adress','$prestation','$dateS')");
 if ($devis) {
   echo"<script> alert('Devis bien ajouter'); </script>";
 } else {
