   ...
   <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="dispo.php">tarifs et disponibilités</a>
        </li>
        
         <li class="nav-item">
          <a class="nav-link" href="mofierouvrier.php">consulter les informations personnelles</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">missions</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="espaceouvrier.php">retour</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="connection.php">se déconnecter</a>
        </li>
      </ul>   
    </div>
  </nav>
...
<h3 align="center" style="color:#56828B;">Vos informations personnelles</h3>
 <br/>
...
<form action="" method="post">
                 ...
                 <center>
                        ...
                        <input name="nom" type="text" placeholder="Nom.." required />  <input name="prenom" type="text" placeholder="Prénom.." required />
                        <br/> 
                                               
                        <input  name="email" type="text" placeholder="email.." required/>  <input name="tel" type="text"placeholder="Téléphone.." required />
                                                                                <br/> 

                        <input name="pays" type="text" placeholder="Pays.." required />    <input name="ville" type="text" placeholder="Ville.." required />
                        <br/> 

 

                        <input name="cp" type="text" placeholder="Code Postale.." required/>      <input name="adresse" type="text" placeholder="Adresse.." required />
                        <br/>
                        ...
                        <select  placeholder= "role.." name="prestation">                        
                        ...
                        <input name="id_utilisateur" type="text" placeholder="id_utilisateur.." required /> 
                        <br/> 
...
if (isset($_POST['Modifier'])) {
 ...
 $requete="UPDATE ouvrier SET nom='$nom', email='$email', tele='$tel', codep='$cp', prestation='$prestation', ville='$ville', prenom='$prenom', adresse='$adresse', pays='$pays' WHERE id_utilisateur='$id_utilisateur'"; 
      $resultat = mysqli_query($con,$requete);
      if ($resultat) {
   echo"<script> alert('Ouvrier bien modifier'); </script>";
 } else {
