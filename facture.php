   ...
   <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="dispot.php">tarifs et disponibilités</a>
        </li>
...
<form action="" method="POST">
                 ...
                 <center>
                        ...
                        <input name="id_devis" type="text" placeholder="id_devis.." />
                        <br/>                                                
                        <input  name="heure_t" type="text" placeholder="heure travailler.."/>  <input name="tarif_h" type="text"placeholder="tarif horaire.." />
                        <br/>
                        <input  name="prestation" type="text" placeholder="type de prestation.."/>  <input name="montant" type="text"placeholder="Montant Totale.." />
                        <br/>

<br/>
 <br/>                           <br/>

                        <input  type="submit" value="Ajouter la facture" name="ajt" />
...
<center><h3>Liste des employés : </h3></center> <br> 
                <form action="" method="post">
                  <div class="form-group">
                  <div class="input-group input-group-sm" style="width: 300px; margin-left: 1100px;">
                  <input type="text" name="id" class="form-control" placeholder="Recherche par ID Facture">
...
<?php if (isset($_POST['rech']) ) {
  $id=$_POST['id'];
  $r="SELECT * FROM `facture` WHERE id_facture='$id'";
...
while($P = mysqli_fetch_array($result)){?>
                    ...
                    <tr>
                         <td><?php echo $P['id_facture']; ?></td>
                         <td><?php echo $P['id_devis']; ?></td>  
                         <td><?php echo $P['heureurt']; ?></td>  
                         <td><?php echo $P['tarifh']; ?></td>
...
if(isset($_POST['ajt']))
{
      ...
      $heure_t = $_POST['heure_t'];
      $tarif_h = $_POST['tarif_h'];
      ...
      $requete="INSERT INTO facture (id_devis, heureurt, tarifh, typep, montant) 
                                 VALUES ('$id_devis', '$heure_t', '$tarif_h', '$prestation', '$montant')"; 
